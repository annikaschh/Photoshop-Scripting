...
var docName = nameList[i].replace("FULL_", "");

// Save file
var saveFile = new File( saveFolder + '/' + "DB_TYPE+ALLCERAKOTE_MATERIAL+D+SUNSET_FINISH+POLISH_CERAKOTE+" + docName + '_IMAGE+1.' + saveExt );
